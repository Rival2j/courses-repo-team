...
### F6
 - [x] T611 [P] [F6] [TEAM-02] Integrar `vite-plugin-pwa`/Workbox, prompt de instalacion y placeholders offline. TR: S-RF-005, S-RNF-004.
 - [x] T612 [P] [F6] [TEAM-02] Implementar IndexedDB/background sync para acciones permitidas y restauracion del estado visual. TR: S-RF-005, P-9.

### F7
- [x] T711 [P] [F7] [TEAM-02] Implementar UI administrativa para roles, configuraciones y moderacion de contenido. TR: S-RF-005, S-RNF-004.

### F8
 - [x] T811 [P] [F8] [TEAM-02] Corregir hallazgos de A11Y, UX, responsive y performance del frontend antes del cierre. TR: S-RNF-004, P-14.
